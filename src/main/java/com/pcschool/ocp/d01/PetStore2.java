...
public class PetStore2 {
    public static void main(String[] args) {
        ...
        System.out.printf("品種 :　%s 名字 : %s 年齡 : %d 價格 : %,d 數量 : %d 小計 : %,d\n", Cat.type, c1.name, c1.age, c1.price ,c1.amount, (c1.amount*c1.price));
        System.out.printf("品種 :　%s 名字 : %s 年齡 : %d 價格 : %,d 數量 : %d 小計 : %,d\n", Cat.type, c2.name, c2.age, c2.price ,c2.amount, (c2.amount*c2.price));
    
        int sum = (c1.amount*c1.price)+(c2.amount*c2.price);
